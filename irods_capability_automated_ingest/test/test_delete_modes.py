...
class test_delete_modes_with_sync_operations(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # TODO(#280): The sync job fails without this sleep because the Celery workers don't see the directories.
        time.sleep(1)
    ...
    def assert_deleted_directory_resulted_in_deleted_collection(
        ...
        try:
            # The deleted directory should have resulted in a deleted collection.
            self.assertEqual(
                collection_exists,
                self.irods_session.collections.exists(
                    self.target_subcollection_for_removal
            ...
            # The deleted collection should not have been moved to the trash.
            self.assertEqual(
                collection_in_trash,
                self.irods_session.collections.exists(
